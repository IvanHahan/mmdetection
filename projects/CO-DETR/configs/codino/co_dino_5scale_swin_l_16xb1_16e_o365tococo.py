...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        ann_file="screen_layout_coco/train.json",
        data_prefix=dict(img="screen_layout_labelme/"),
    ),
)
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        ann_file="screen_layout_coco/val.json",
        data_prefix=dict(img="screen_layout_labelme/"),
    )
)
...
val_evaluator = dict(
    type="CocoMetric",
    ann_file=os.path.join(data_root, "screen_layout_coco/val.json"),
    metric=["bbox", "segm"],
    format_only=False,
    backend_args=None,
)
